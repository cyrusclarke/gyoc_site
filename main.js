...
function resize() {
	...
	var tHeight = document.querySelector('.parallax .text .inner ').offsetHeight;
	
	layers.forEach(function(l) {
		console.log(l);
		l.style.height = tHeight+1000+'px';
	});
}
  ...
  window.addEventListener("load", function(event) {
	...
	window.addEventListener("hashchange", function() {
		...
		if(name=='') {
			...
			nis.forEach(function(n) {
				n.classList.remove('active');
			});

			var ni = document.querySelector('.name-'+name);
	...
	var researchers = document.querySelectorAll('.researcher');
	researchers.forEach(function(researcher) {
		researcher.addEventListener('click', function(e) {
			var id = researcher.getAttribute('data-id');
			if(id) {
				var r = document.querySelector('.researcher-'+id);
	...
	var crosses = document.querySelectorAll('.overlaytext .cross');
	crosses.forEach(function(cross) {
		cross.addEventListener('click', function(e) {
			var ot = cross.closest('.overlaytext');
